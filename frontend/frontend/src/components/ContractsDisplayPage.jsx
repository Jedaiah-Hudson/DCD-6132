...
const WORKSPACE_CONFIG = {
  ...
  matchmaking: {
    ...
    sectionHelperText: 'These contracts are tailored to your saved profile, NAICS codes, and capability materials.',
    ...
    overviewText: 'The backend filters this list against the NAICS codes saved on your capability profile.',
